...
global H Flag Parameter Nline Body Jnt
global spline_type
%%
...
%%
%... Contribution to rhs of velocity equations
if Flag.Velocity == 1
    switch type
        case 1
...
if Flag.Acceleration == 1
    switch type
        ...
        case 5
            ...
            gamma(i1:i1,1) =-2*dd'*dd + ...
                             2*d'*(Body(i).A*Jnt.Driver(k).spPi*tid^2 - ...
                                   Body(j).A*Jnt.Driver(k).spPj*tjd^2) + ...
                             2*(ppval(Jnt.Driver(k).Splined ,time)^2+ ...
